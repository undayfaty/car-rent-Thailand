...
CREATE TYPE "price_type" AS ENUM('per_day', 'per_booking', 'per_hour');--> statement-breakpoint
...
CREATE TABLE "add_ons" (
	...
	"type" "price_type" DEFAULT 'per_booking'::"price_type",
...
--> statement-breakpoint
ALTER TABLE "booking_add_ons" ADD CONSTRAINT "booking_add_ons_booking_id_bookings_id_fkey" FOREIGN KEY ("booking_id") REFERENCES "bookings"("id") ON DELETE CASCADE;--> statement-breakpoint
ALTER TABLE "booking_add_ons" ADD CONSTRAINT "booking_add_ons_add_on_id_add_ons_id_fkey" FOREIGN KEY ("add_on_id") REFERENCES "add_ons"("id");--> statement-breakpoint
